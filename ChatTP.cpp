...
// ChatTP.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CChatTPApp, CWinApp)
...
// Единственный объект CChatTPApp

CChatTPApp theApp;


// Инициализация CChatTPApp

BOOL CChatTPApp::InitInstance()
{
